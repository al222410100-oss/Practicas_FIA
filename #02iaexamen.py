...
lista= input ("Aparece en la lista oficial de alumnos (si/no): ").lower()
# ----------------------------------------------------------
...
T=lista=="si"
# T es verdadera cuando aparece en la lista oficial de alumnos
# ----------------------------------------------------------
